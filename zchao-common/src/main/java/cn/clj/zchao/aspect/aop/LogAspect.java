package cn.clj.zchao.aspect.aop;


import cn.clj.zchao.aspect.annotation.ControllerLogs;
import cn.clj.zchao.aspect.annotation.ServiceLogs;
import cn.clj.zchao.aspect.util.IpUtil;
import cn.clj.zchao.aspect.util.UriStringUtil;
import cn.clj.zchao.aspect.util.UserAgentUtil;
...
public class LogAspect {
     ...
     * Service层切点
     */
    @Pointcut("@annotation(cn.clj.zchao.aspect.annotation.ServiceLogs)")
     ...
     * Controller层切点
     */
    @Pointcut("@annotation(cn.clj.zchao.aspect.annotation.ControllerLogs)")
    ...
    public void doBefore(JoinPoint joinPoint) {
        try {
            ...
            sb.append("RequestUri    :  ").append(UriStringUtil.abbr(request.getRequestURI(), 255)).append("\n");
            sb.append("**************************");
    ...
    public void doAfterReturning(Object ret) throws Throwable {
        HttpServletRequest request = ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
        //请求方法
        String method = UriStringUtil.abbr(request.getRequestURI(), 255);
        StringBuilder sb = new StringBuilder(1000);
        // 处理完请求，返回内容
        sb.append("\n");
